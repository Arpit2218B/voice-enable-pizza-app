...
import type { ModelContextTool, ModelContextToolFromSchema, ToolDescriptor, ToolDescriptorFromSchema, ToolListItem, WebMcpToolAnnotations } from './tool.js';
...
export interface ChromeModelContextExtensions {
    executeTool?(tool: RegisteredTool, inputArguments: string, options?: ChromeModelContextExecuteToolOptions): Promise<string | null>;
}
...
export interface ModelContextTesting extends EventTarget {
    ...
    executeTool(toolName: string, inputArgsJson: string, options?: ChromeModelContextExecuteToolOptions): Promise<string | null>;
...
export interface ModelContext extends EventTarget {
    registerTool<const TInputSchema extends JsonSchemaForInference, TResult = unknown, TName extends string = string>(tool: ModelContextToolFromSchema<TInputSchema, TResult, TName>, options?: ModelContextRegisterToolOptions): Promise<void>;
    registerTool<TInputSchema extends InputSchema, TArgs extends WebMcpToolInput = WebMcpToolInput, TResult = unknown, TName extends string = string>(tool: ModelContextTool<TArgs, TResult, TName> & {
        inputSchema: TInputSchema;
    } & WidenedSchema<TInputSchema>, options?: ModelContextRegisterToolOptions): Promise<void>;
    registerTool<TArgs extends WebMcpToolInput = Record<string, unknown>, TResult = unknown, TName extends string = string>(tool: Omit<ModelContextTool<TArgs, TResult, TName>, 'inputSchema'> & {
        inputSchema?: undefined;
    }, options?: ModelContextRegisterToolOptions): Promise<void>;
...
export interface ModelContextExtensions {
    registerTool<const TInputSchema extends JsonSchemaForInference, const TOutputSchema extends JsonSchemaForInference | undefined = undefined, TName extends string = string>(tool: ToolDescriptorFromSchema<TInputSchema, TOutputSchema, TName>, options?: ModelContextRegisterToolOptions): Promise<void>;
    registerTool<TInputSchema extends InputSchema, TArgs extends WebMcpToolInput = WebMcpToolInput, TName extends string = string>(tool: ToolDescriptor<TArgs, unknown, TName> & {
        inputSchema: TInputSchema;
    } & WidenedSchema<TInputSchema>, options?: ModelContextRegisterToolOptions): Promise<void>;
    registerTool<TArgs extends WebMcpToolInput = Record<string, unknown>, TName extends string = string>(tool: Omit<ToolDescriptor<TArgs, unknown, TName>, 'inputSchema'> & {
        inputSchema?: undefined;
    }, options?: ModelContextRegisterToolOptions): Promise<void>;
    listTools(): ToolListItem[];
}
export type ChromeModelContext = ModelContext & ChromeModelContextExtensions;
export type ModelContextWithExtensions = Omit<ModelContext, 'registerTool'> & ModelContextExtensions;
export {};
