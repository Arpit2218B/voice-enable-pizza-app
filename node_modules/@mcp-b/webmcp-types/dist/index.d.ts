...
export type { CallToolResult, ContentBlock, InputSchema, JsonObject, JsonValue, RegistrationHandle, TextContent, WebMcpToolInput, } from './common.js';
export type { InferArgsFromInputSchema, InferJsonSchema, JsonSchemaForInference, } from './json-schema.js';
export type { ChromeModelContext, ChromeModelContextExecuteToolOptions, ChromeModelContextExtensions, ModelContext, ModelContextExtensions, ModelContextGetToolOptions, ModelContextRegisterToolOptions, ModelContextTesting, ModelContextTestingToolInfo, ModelContextWithExtensions, RegisteredTool, } from './model-context.js';
export type { MaybePromise, ModelContextTool, ToolAnnotations, ToolDescriptor, ToolDescriptorFromSchema, ToolListItem, ToolResultFromOutputSchema, WebMcpToolAnnotations, } from './tool.js';
declare global {
    /**
